...
public class ItemInit {
    ...
    public static final RegistryObject<Item> SUPERHEATED_COPPER_INGOT = ITEMS.register("superheated_copper_ingot", () -> new Item(new Item.Properties().group(Main.ModItemGroup.instance)));
