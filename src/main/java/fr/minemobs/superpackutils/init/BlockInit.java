...
public class BlockInit {
    ...
    public static final RegistryObject<Block> DEEPSLATE = BLOCKS.register("deepslate",
            () -> new Block(AbstractBlock.Properties.copy(Blocks.STONE).strength(0.75F, 3.0F).harvestTool(ToolType.PICKAXE).harvestLevel(4)));
    ...
    //Casing
    public static final RegistryObject<Block> BIG_STEEL_CASING = BLOCKS.register("big_steel_casing", () -> new Block(AbstractBlock.Properties.copy(Blocks.DIAMOND_BLOCK)));
    public static final RegistryObject<Block> INSCRIBER_CASING = BLOCKS.register("inscriber_casing", () -> new Block(AbstractBlock.Properties.copy(Blocks.DIAMOND_BLOCK)));
    ...
    public static final RegistryObject<Block> CRUSHER_CASING = BLOCKS.register("crusher_casing", () -> new Block(AbstractBlock.Properties.copy(Blocks.DIAMOND_BLOCK)));
