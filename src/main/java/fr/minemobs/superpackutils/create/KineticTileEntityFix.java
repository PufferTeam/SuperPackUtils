package fr.minemobs.superpackutils.create;
...
/**
 * @author mrh0
 * (https://github.com/mrh0/createaddition/blob/main/src/main/java/com/mrh0/createaddition/create/KineticTileEntityFix.java)
 */
